...
/**
 * This is the item provider adapter for a {@link function.function.Function} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionItemProvider
	...
	protected void addOutputsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Function_outputs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Function_outputs_feature", "_UI_Function_type"),
				 FunctionPackage.Literals.FUNCTION__OUTPUTS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Function.class)) {
			...
			case FunctionPackage.FUNCTION__OUTPUTS:
